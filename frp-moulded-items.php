    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="prod-img-main">
          ...
          <div class="prod-box">
            <img src="images/product/moulded/frp1.webp" alt="Chemical Storage Room" class="img-responsive" />
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-4">
        <div class="prod-img-main">
          ...
          <div class="prod-box">
            <img src="images/product/moulded/duct.webp" alt="PP FRP Chamber" class="img-responsive" />
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-4">
        <div class="prod-img-main">
          ...
          <div class="prod-box">
            <img src="images/product/moulded/frp5.webp" alt="FRP Moulded Item" class="img-responsive" />
          </div>
        </div>
      </div>
    </div>
